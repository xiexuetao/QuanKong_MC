...
- (id)initWithFrame:(CGRect)frame arrowImageName:(NSString *)arrow textColor:(UIColor *)textColor  {
    if((self = [super initWithFrame:frame])) {
		...
		layer.frame = CGRectMake(25.0f, 5, 23.0f, 45.0f);
...
- (void)setState:(PullLoadMoreState)aState{
	...
	switch (aState) {
        ...
        {
			_statusLabel.text = NSLocalizedString(@"放开加载...", @"Release to load more status");
			[CATransaction begin];
...
//	[scrollView setContentInset:UIEdgeInsetsMake(0.0f, 0.0f, 60.0f, 0.0f)];
//	[UIView commitAnimations];
