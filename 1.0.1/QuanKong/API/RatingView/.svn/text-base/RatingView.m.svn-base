...
-(void)setImagesDeselected:(NSString *)deselectedImage
    ...
    unselectedStr = deselectedImage;
    partlySelectedStr = halfSelectedImage;
    fullySelectedStr = fullSelectedImage;
    
	unSelectedImage = [UIImage imageNamed:unselectedStr];
	partlySelectedImage = partlySelectedStr == nil ? unSelectedImage : [UIImage imageNamed:partlySelectedStr];
	...
	[s2 setFrame:CGRectMake(width+2,     0, width, height)];
	[s3 setFrame:CGRectMake(2 * (width+2), 0, width, height)];
	[s4 setFrame:CGRectMake(3 * (width+2), 0, width, height)];
	[s5 setFrame:CGRectMake(4 * (width+2), 0, width, height)];
...
-(void)displayRating:(float)rating {
    ...
    unSelectedImage = [UIImage imageNamed:unselectedStr];
    partlySelectedImage = [UIImage imageNamed:partlySelectedStr];
    fullySelectedImage = [UIImage imageNamed:fullySelectedStr];
